...
from diffusion_policy.model.vision.model_getter import get_clip_encoder, get_resnet
...
def create_obs_encoder(
    ...
    #! mahesh this combines the image and the qpos
