...
- **`DiffusionVLA/dataset/collect_data.py`**: Collects demonstration trajectories with images, joint positions, and text labels
- **`DiffusionVLA/train/train.py`**: Trains the diffusion policy model on collected data
- **`DiffusionVLA/franka_test_image.py`**: Tests the trained model in simulation
...
**Usage:**
```bash
python DiffusionVLA/dataset/collect_data.py --collect --num_episodes 100
```
...
**Usage:**
```bash
python DiffusionVLA/train/train.py
```
...
**Usage:**
```bash
python DiffusionVLA/franka_test_image.py --checkpoint outputs/franka_arm_image_training/checkpoints/final --view
```
